...
parser.add_argument("--data_dir", action="store", dest="data_dir", default="/media/lf-fl/feng/experiments/cvpr2021/camera_ready/release_code/data/voxel_color/", help="Root directory of dataset [data]")
